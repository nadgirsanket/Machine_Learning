...
rounds = 20
df = pd.read_csv(
    filepath_or_buffer='https://archive.ics.uci.edu/ml/machine-learning-databases/letter-recognition/letter-recognition.data', 
    header=None, 
    sep=',')
...
#
##Elbow graph
##plot variance for each value for 'k' between 1,26
#initial = [cluster.vq.kmeans(data,i) for i in range(1,27)]
